        ...
        <Container className={styles.inner}>
          <div className={styles.text}>
            ...
            <p>
              ...
              Feature Flags and rolled out to production for the last year.
              Expert level React.js and great product sense, have reach
              expertise in code reviewing. In love with Functional Paradigm.
            </p>
          </div>
